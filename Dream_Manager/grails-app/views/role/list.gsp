				...
				<thead>
					<tr>
						...
						<g:sortableColumn property="id"
							title="${message(code: 'Role.id.label', default: 'Id')}" />

						<g:sortableColumn property="name"
							title="${message(code: 'Role.name.label', default: 'Name')}" />

						<th>
							${message(code: 'User.users.label', default: 'Users')}
						</th>

						<th>
							${message(code: 'User.permissions.label', default: 'Permissions')}
						</th>
				...
				<tbody>
					<g:each in="${RoleInstanceList}" status="i" var="RoleInstance">
						<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
							...
							<td>
								${fieldValue(bean: RoleInstance, field: "users")}
							</td>

							<td>
								${fieldValue(bean: RoleInstance, field: "permissions")}
							</td>
