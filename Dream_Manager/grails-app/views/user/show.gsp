	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="avatarLocation-label" class="property-label"><g:message code="user.avatarLocation.label" default="Avatar Location" /></span>
					
						<span class="property-value" aria-labelledby="avatarLocation-label"><g:fieldValue bean="${userInstance}" field="avatarLocation"/></span>
				...
				<li class="fieldcontain">
					<span id="streetAddress1-label" class="property-label"><g:message code="user.streetAddress1.label" default="Street Address1" /></span>
					
						<span class="property-value" aria-labelledby="streetAddress1-label"><g:fieldValue bean="${userInstance}" field="streetAddress1"/></span>
				...
				<li class="fieldcontain">
					<span id="streetAddress2-label" class="property-label"><g:message code="user.streetAddress2.label" default="Street Address2" /></span>
					
						<span class="property-value" aria-labelledby="streetAddress2-label"><g:fieldValue bean="${userInstance}" field="streetAddress2"/></span>
				...
				<li class="fieldcontain">
					<span id="poBox-label" class="property-label"><g:message code="user.poBox.label" default="Po Box" /></span>
					
						<span class="property-value" aria-labelledby="poBox-label"><g:fieldValue bean="${userInstance}" field="poBox"/></span>
				...
				<li class="fieldcontain">
					<span id="dreams-label" class="property-label"><g:message code="user.dreams.label" default="Dreams" /></span>
					
						<g:each in="${userInstance.dreams}" var="d">
						<span class="property-value" aria-labelledby="dreams-label"><g:link controller="dream" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="isManager-label" class="property-label"><g:message code="user.isManager.label" default="Is Manager" /></span>
					
						<span class="property-value" aria-labelledby="isManager-label"><g:formatBoolean boolean="${userInstance?.isManager}" /></span>
